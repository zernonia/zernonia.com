...
<template>
  <footer class="mt-6 md:mt-12 w-full flex flex-col md:flex-row justify-between">
    <div class="flex space-x-2 md:space-x-4 text-dark-900 dark:text-light-900">
      <a href="https://github.com/zernonia" target="_blank"><IconGithub class="w-5 md:w-6 h-auto fill-current" /></a>
      <a href="https://twitter.com/zernonia" target="_blank"><IconTwitter class="w-5 md:w-6 h-auto fill-current" /></a>
      <a href="https://dribbble.com/zernonia" target="_blank"
        ><IconDribbble class="w-5 md:w-6 h-auto fill-current"
      /></a>
      <a href="https://dev.to/zernonia" target="_blank"><IconDevTo class="w-5 md:w-6 h-auto fill-current" /></a>
